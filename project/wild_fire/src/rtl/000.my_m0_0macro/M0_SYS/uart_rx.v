...
//Internal Signals  
  ...
  always @ (posedge clk, negedge resetn)
    begin
      if(!resetn)
        ...
        case(current_state)
          idle_st: bps_cnt_reg <= 'd0;
          default: 
            if(bps_cnt_reg < UART_BPS_TIME) begin
  ...
  wire b_tick;
  assign b_tick = bps_cnt_reg ==  UART_BPS_TIME ? 1'b1:1'b0;
