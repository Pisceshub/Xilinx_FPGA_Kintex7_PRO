...
//                                                                              //
//THIS END USER LICENCE AGREEMENT (閿熺祪ICENCE閿燂拷) IS A LEGAL AGREEMENT BETWEEN      //
...
module AHBDCD(
  ...
  output reg [3:0] MUX_SEL  //BCD-->MUX_SEL,next time cycle sel slave signal to master
                              //the cycle of next time relize is in AHBMUX module
    );
