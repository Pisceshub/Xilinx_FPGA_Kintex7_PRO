...
#
# Generated by Vivado on Sat Aug 19 17:57:09 CST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../k325t.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../k325t.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ICer/Work_file/Vivadoprj/K7prj/my_project/my_project.cache/compile_simlib/vcs"
  fi
